...
<h1>TestDrives</h1>
<div class="name">
<h6 style="margin-left:10px;"><a href="#"style="text-decoration:none;color:black;">Home</a>&nbsp;/&nbsp;Sales</a></h6>
</div><br>
...
<table id= "ta" >
  ...
  <tbody>
    <?php
        $count=1;
         $query=mysqli_query($con,"select car_id,distict count(*) from tbl_ltestdrive");
